...
export default function AboutMePage() {
  ...
  return (
    <div className="h-full w-full bg-white/8 backdrop-blur-sm overflow-x-hidden">
      {/* Two-column layout */}
      <div className="flex flex-col-reverse md:flex-row max-w-7xl mx-auto pt-20 pb-10">
        {/* Left sided content */}
        <div className="md:flex-1 px-4">
          ...
          <div className="mt-8">
            ...
            <p className="text-muted-foreground mt-2 leading-tight">Certain skills I've picked along the way that deserve mentioning:</p>
            <ul className="list-disc list-inside mt-4 space-y-2 text-muted-foreground">
              <li className="leading-tight">Strong problem-solving abilities, able to analyze complex issues and develop effective solutions.</li>
              <li className="leading-tight">Excellent communication skills, both written and verbal, enabling effective collaboration with team members and stakeholders.</li>
              <li className="leading-tight">Adaptability and flexibility, able to thrive in dynamic environments and quickly learn new technologies and methodologies.</li>
              <li className="leading-tight">Time management and organizational skills, able to prioritize tasks and meet deadlines efficiently.</li>
              <li className="leading-tight">Team player mentality, fostering a collaborative work environment and contributing positively to team dynamics.</li>
            </ul>
          </div>
        </div>

        {/* Right sided content */}
        <div className="md:flex-1 mx-auto p-6 flex flex-col space-y-4 justify-start items-center">
          <Image
            src="/IMG_7311~2.png"
            alt="Profile Picture"
            width={300}
      ...
      <div className=" items-center justify-center max-w-7xl py-10 mx-auto">
